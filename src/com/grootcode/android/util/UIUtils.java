...
public class UIUtils {
    ...
    public static final String TARGET_FORM_FACTOR_ACTIVITY_METADATA = "com.grootcode.android.meta.TARGET_FORM_FACTOR";
    ...
    public static void setKeyboardFocus(final EditText primaryTextField) {
        (new Handler()).postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                primaryTextField.dispatchTouchEvent(motionEvent);
                motionEvent.recycle();
    ...
    public static boolean hasFroyo() {
        // Can use static final constants like FROYO, declared in later versions of the OS since
        // they are inlined at compile time. This is guaranteed behavior.
    ...
    public static void enableDisableActivitiesByFormFactor(Context context) {
        ...
        try {
            ...
            for (ActivityInfo info : activityInfos) {
                ...
                pm.setComponentEnabledSetting(new ComponentName(context, Class.forName(className)),
