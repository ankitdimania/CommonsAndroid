...
public class ImageLoader extends com.android.volley.toolbox.ImageLoader {
    ...
    private final ArrayList<Drawable> mPlaceHolderDrawables;
    ...
    public ImageContainer get(String requestUrl, ImageView imageView, ImageListener clientImageListener) {
        return get(requestUrl, imageView, 0, clientImageListener);
    }

    public ImageContainer get(String requestUrl, ImageView imageView, int placeHolderIndex) {
        return get(requestUrl, imageView, placeHolderIndex, mMaxImageWidth, mMaxImageHeight);
    }

    public ImageContainer get(String requestUrl, ImageView imageView, int placeHolderIndex, ImageListener clientImageListener) {
        return get(requestUrl, imageView, placeHolderIndex, mMaxImageWidth, mMaxImageHeight, clientImageListener);
    }
    ...
    public ImageContainer get(String requestUrl, ImageView imageView, Drawable placeHolder, ImageListener clientImageListener) {
        return get(requestUrl, imageView, placeHolder, mMaxImageWidth, mMaxImageHeight, clientImageListener);
    }
    public ImageContainer get(String requestUrl, ImageView imageView, int maxWidth, int maxHeight) {
        return get(requestUrl, imageView, 0, maxWidth, maxHeight);
    }

    public ImageContainer get(String requestUrl, ImageView imageView, int maxWidth, int maxHeight, ImageListener clientImageListener) {
        return get(requestUrl, imageView, 0, maxWidth, maxHeight, clientImageListener);
    }

    public ImageContainer get(String requestUrl, ImageView imageView, int placeHolderIndex, int maxWidth, int maxHeight) {
        return get(requestUrl, imageView, mPlaceHolderDrawables.get(placeHolderIndex), maxWidth, maxHeight);
    }
    public ImageContainer get(String requestUrl, ImageView imageView, int placeHolderIndex, int maxWidth, int maxHeight, ImageListener clientImageListener) {
        return get(requestUrl, imageView, mPlaceHolderDrawables.get(placeHolderIndex), maxWidth, maxHeight, clientImageListener);
    }
    
    public ImageContainer get(String requestUrl, ImageView imageView, Drawable placeHolder, int maxWidth, int maxHeight) {
        return get(requestUrl, imageView, placeHolder, maxWidth, maxHeight, null);
    }

    public ImageContainer get(String requestUrl, ImageView imageView, Drawable placeHolder, int maxWidth,
            int maxHeight, ImageListener clientImageListener) {
        ...
        if (requestUrl == null || !requestUrl.equals(recycledImageUrl)) {
            ...
            if (requestUrl != null) {
                ...
                imageContainer = get(requestUrl,
                        getImageListener(mResources, imageView, placeHolder, mFadeInImage, clientImageListener),
                        maxWidth, maxHeight);
    ...
    private static ImageListener getImageListener(final Resources resources, final ImageView imageView,
            final Drawable placeHolder, final boolean fadeInImage, final ImageListener clientImageListener) {
        return new ImageListener() {
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                ...
                if (clientImageListener != null) {
                    clientImageListener.onResponse(response, isImmediate);
                }
            }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                if (clientImageListener != null) {
                    clientImageListener.onErrorResponse(volleyError);
                }
            }
        };
    }
